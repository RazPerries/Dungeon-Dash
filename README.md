# Dungeon Dash
A turn-based game where a treasure hunter raids a dangerous dungeon, looking for any spoils it might have. This game focuses on player engagement by introducing mechanics that go beyond turn-based combat, such as interacting to enemy attacks with parrying, evading, or blocking. It also introduces a method for enemies to engage with the player’s attacks. 
...
### Basic Attack 
Simple attack that deals 100% of the player’s attack. It is the player’s way of dealing guaranteed damage, as it requires no quick-time events and is not affected by attack sabotages or stances.  
...
- Types of Planned Sabotages: Speed up, Size Down, Dual Lane, Obstacles, Count Up 
...
- **Parrying:** The enemy will interrupt your attack and counterattack you. This is planned to only be applied to the boss of the game. 
